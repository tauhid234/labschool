		...
		<div class="container">
			...
			<form class="row g-3" style="margin-top: 60px;" method="POST">
					...
					<fieldset class="row col-md-12 mb-4">
						...
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="asal_unit" id="smp" value="smp" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						...
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="unit_penilaian" id="tu_smp" value="tu_smp" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						...
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="kecepatan_layanan" id="kecepatan_layanan_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						<legend class="col-form-label col-sm-2">Penyelesaian Layanan <span style="color: red;">*</span></legend>
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="penyelesaian_layanan" id="penyelesaian_layanan_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						<legend class="col-form-label col-sm-2">Penguasaan Bidang Kerja <span style="color: red;">*</span></legend>
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="penguasaan_bidang_kerja" id="penguasaan_bidang_kerja_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						<legend class="col-form-label col-sm-2">Ketersediaan Informasi <span style="color: red;">*</span></legend>
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="ketersediaan_informasi" id="ketersediaan_informasi_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						<legend class="col-form-label col-sm-2">Ketersediaan Panduan/Petunjuk <span style="color: red;">*</span></legend>
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="ketersediaan_panduan_petunjuk" id="ketersediaan_panduan_petunjuk_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						<legend class="col-form-label col-sm-2">Penanganan Komplain <span style="color: red;">*</span></legend>
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="penanganan_komplain" id="penanganan_komplain_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						...
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="pendokumentasian" id="pendokumentasian_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						<legend class="col-form-label col-sm-2">Keterbukaan Penyelesaian Komplain <span style="color: red;">*</span></legend>
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="keterbukaan_penyelesaian_komplain" id="keterbukaan_penyelesaian_komplain_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						<legend class="col-form-label col-sm-2">Kebersihan Ruangan Pelayanan <span style="color: red;">*</span></legend>
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="kebersihan_ruang_pelayanan" id="kebersihan_ruang_pelayanan_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						<legend class="col-form-label col-sm-2">Ketersediaan Ruangan Pelayanan yang memadai <span style="color: red;">*</span></legend>
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="ketersediaan_ruangan_pelayanan_memadai" id="ketersediaan_ruangan_pelayanan_memadai_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						<legend class="col-form-label col-sm-2">Kenyamanan Ruangan Pelayanan <span style="color: red;">*</span></legend>
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="kenyamanan_ruangan_pelayanan" id="kenyamanan_ruangan_pelayanan_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						...
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="keramahan_senyum" id="keramahan_senyum_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						...
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="kerapihan" id="kerapihan_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						...
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="keberadaan_staff" id="keberadaan_staff_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						<legend class="col-form-label col-sm-2">Perhatian dan responsif dalam melayani <span style="color: red;">*</span></legend>
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="perhatian_responsif" id="perhatian_responsif_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						<legend class="col-form-label col-sm-2">Keakuratan Informasi yang diberikan <span style="color: red;">*</span></legend>
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="keakuratan_informasi" id="keakuratan_informasi_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						...
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="informasi_terkini" id="informasi_terkini_1" value="1" checked>
					...
					<fieldset class="row col-md-12 mb-4">
						<legend class="col-form-label col-sm-2">Kelengkapan Informasi <span style="color: red;">*</span></legend>
						<div class="col-sm-10">
							<div class="form-check">
								<input class="form-check-input" type="radio" name="kelengkapan_informasi" id="kelengkapan_informasi_1" value="1" checked>
