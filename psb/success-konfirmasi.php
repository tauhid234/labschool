                        ...
                        <div class="panel panel-default">
                            <div class="panel-body" align="justify" style="margin-top:20px;">
                                <div class='alert alert-success' align='center'>
                                    <strong>Konfirmasi pembayaran yang anda lakukan berhasil.</strong><br>
                                    Silahkan klik link <a href="status_daftar" style='font-weight:bold; text-decoration:none;'>STATUS PENDAFTARAN</a> berikut untuk melakukan pengecekan atas proses pendaftaran anda.<br>
                                    Kami akan segera menghubungi anda kembali melalui email terdaftar setelah konfirmasi pembayaran selesai di validasi.
                                </div>
                            </div>
                        </div>
                    </div>
