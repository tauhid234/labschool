<?php
    ...
    if(!isset($_GET['p_id']))
    {
        header("location:ppsbb-form");
    }
    else
    {
        $peserta_id=$_GET['p_id'];
        $kode_daftar = "";
        $nama_peserta = "";
        $email = "";

        $query = $conn->prepare("SELECT * FROM ms_peserta JOIN ms_daftar ON ms_daftar.peserta_id=ms_peserta.peserta_id WHERE ms_peserta.peserta_id=$peserta_id");
        $query->execute();
        ...
        <div class="container">
            <div class="section-title row text-center" style="margin-top:50px;">
                <div class="col-md-8 offset-md-2">
                    <h3 style="margin-top:30px;">PPSBB</h3>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body" align="justify" style="margin-top:20px;">
                                <!-- <div class='alert alert-success' align='center'>
                                    <strong>Success!</strong> Registrasi yang anda lakukan berhasil.<br>Silahkan klik <a href="#" style='font-weight:bold; text-decoration:none;'>LINK TAGIHAN</a> berikut untuk melakukan pengecekan atas tagihan anda, atau klik <a href="#" style='font-weight:bold; text-decoration:none;'>LINK PRINT</a> TAGIHAN berikut untuk melakukan pencetakan atas tagihan anda dan melanjutkan proses PSB Online.
                                </div> -->

                                <div class='alert alert-success' align='center' style='width:80%; margin-left:10%;'>
                                    <strong>Pendaftaran jalur prestasi yang anda lakukan berhasil.</strong><br>
                                    <br>
                                    ...
                                    <br>
                                    Kami akan segera menghubungi anda kembali untuk informasi pengumpulan dokumen yang dibutuhkan.<br>
                                    Mohon untuk melakukan pengecekan secara berkala ke dalam inbox email terdaftar.
                                </div>
                            </div>
                        </div>
                    </div>
