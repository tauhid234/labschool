        ...
        <div class="container">
            <div class="section-title row text-center" style="margin-top:50px;">
                <?php
						...
						if($_GET["msg"]=="Success")
						{
							echo "
								<div class='alert alert-success' align='center' style='width:80%; margin-left:10%;'>
									<strong>Konfirmasi yang anda lakukan berhasil.</strong><br><br>
									Nomor pembelian formulir anda : <strong>".$_SESSION['inv_number']."</strong><br>
									Biaya pendaftaran : <strong>Rp 300.000,-</strong><br>
									*pembayaran dilakukan kenomor rekening BNI a/n Labschool Cirendeu<br><br>
									Silahkan klik <a href='konfirmasi_pembayaran' style='font-weight:bold; text-decoration:none;'>LINK KONFIRMASI</a> berikut untuk melakukan konfirmasi pembayaran dan melanjutkan proses PSB Online.
								</div>

								<div>
									<img src='../images/BNI-LABSREN.png' alt='' style='height:180px; margin-top:20px;' />
								</div>
								<p style='font-size:13px; color:red; margin-top:10px;'>*pembayaran diluar dari rekening yang telah di informasikan, tidak menjadi tanggung jawab pihak Labschool Cirendeu</p>
							";
						}
						else
						{
							echo "
								<div class='alert alert-danger' align='center' style='width:50%; margin-left:25%;'>
									<strong>Gagal!</strong> Konfirmasi anda gagal karena kode konfirmasi tidak valid. Silahkan lakukan registrasi ulang atau hubungi admin kami.
								</div>
							";
						}
					}
					...
					{
						echo "
							<div class='alert alert-info' align='center' style='width:50%; margin-left:25%;'>
								<strong>Information!</strong> You don't have anything to do here.
							</div>
						";
					}
				?>
