        ...
        <div class="container">
            <div class="row" style="margin-top: 60px;">
                ...
                <div class="col-lg-4 overlay">
                    <p style="font-size:26px; font-weight:bold; text-align: center;">PENERIMAAN SISWA BARU</p>
                    <p style="font-size:18px; text-align: center; margin-top:-15px;">Jalur Reguler</p>
                    <img src="img/akademik.jpg" class="image" width="100%">
                    <a href="https://forms.gle/CMFyGxFGFgU5rBDd7"><div class="middle">
                        <div class="text">Daftar PSB</div>
                    </div></a>
                </div>
                <div class="col-lg-2"></div>
                <div class="col-lg-4 overlay">
                    <p style="font-size:26px; font-weight:bold; text-align: center;">PENERIMAAN SISWA BARU</p>
                    <p style="font-size:18px; text-align: center; margin-top:-15px;">Jalur Prestasi</p>
                    <img src="img/non_akademik.jpg" class="image" width="100%">
                    <a href="https://ppsbb.labschool-unj.sch.id/"><div class="middle">
                        <div class="text">Daftar PPSBB</div>
                    </div></a>
                </div>
                <div class="col-lg-1"></div>
            </div>
