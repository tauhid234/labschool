        ...
        <div class="container">
			...
			<div class="row" style="margin-top:30px;">
				<div class="col-lg-12 col-md-12 col-12">
					...
					?>
					<form name="konfirmasi-pembayaran" action="controller/doKonfirmasi.php" method="post" enctype="multipart/form-data">
						<?php
                    		if(isset($_SESSION['inv_number']))
                    		{
                        		$invoice = $_SESSION['inv_number'];
                    		}
                    		else
                    		{
                    			$invoice = "";
                    		...
                    		$query = $conn->prepare("SELECT * FROM ms_user JOIN ms_tagihan ON ms_tagihan.user_id = ms_user.user_id WHERE ms_tagihan.keterangan = '$invoice'");
							$query->execute();
						...
						<div class="form-group">
						    <label for="invNumber">Kode Formulir <span style="color:#FF0000;">*</span></label>
						    <input type="text" class="form-control" id="invNumber" name="invNumber" value="<?=$invoice;?>" required>
						</div>
						<div class="form-group">
