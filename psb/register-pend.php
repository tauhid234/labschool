...
<body class="host_version">
    ...
    <div id="overviews" class="section wb">
        <div class="container">
            <div class="section-title row text-center" style="margin-top:120px;">
                <div class="alert alert-info" align="center" style="width:50%; margin-left:25%;">
        			<strong>Informasi!</strong> Kami telah mengirim pesan konfirmasi ke email anda. Untuk melanjutkan proses PSB Online Sekolah Labschool Cirendeu, silahkan buka email anda dan ikuti panduan yang telah kami berikan. Apabila tidak terdapat email kami didalam inbox anda, mohon cek spam dalam email anda.</div>
            </div><!-- end title -->
        </div><!-- end container -->
    </div><!-- end section -->
