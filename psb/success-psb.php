<?php
    ...
    {
        header("location:psb-form.php");
    }
    else
    {
        $kode_booking=$_SESSION['kode_booking'];
        $query = $conn->prepare("SELECT * FROM ms_daftar_psb WHERE kode_booking='$kode_booking'");
        $rs = $query->execute();
...
<body class="host_version">
    ...
    <div id="overviews" class="section wb">
        <div class="container">
            <div class="section-title row text-center" style="margin-top:35px;">
                <div class="col-md-8 offset-md-2">
                    <h3 style="margin-top:30px;">PSB</h3>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-body" align="justify" style="margin-top:20px;">
                                <div class='alert alert-success' align='center' style='width:80%; margin-left:10%;'>
                                    <?php
                                        if(isset($_SESSION['sudah_daftar']))
                                        {
                                            echo '<strong>Pendaftar sudah tercatat sebelumnya di dalam database kami :</strong><br>';
                                        }
                                        else
                                        {
                                            echo '<strong>Pendaftaran jalur reguler yang anda lakukan berhasil.</strong><br>';
                                        }unset($_SESSION['sudah_daftar']);
                                    ?>
                                    <br>
                                    Nama Peserta : <strong><?=$nama_peserta;?></strong><br>
                                    Email Peserta : <strong><?=$email;?></strong><br>
                                    Kode Pendaftaran : <strong><?=$kode_daftar;?></strong><br>
                                    Biaya Pendaftaran : <strong>Rp 300.000,-</strong><br>
                                    <br>
                                    Untuk melanjutkan proses pendaftaran siswa baru, silahkan lakukan pembayaran kenomor rekening dibawah ini :<br>
                                    <div class="row" style="margin-top: 20px;">
                                        <!--<img src="../images/mandiri-edukarsa.png" width="40%" style="margin-left: 34%;">-->
                                        <img src="../images/mandiri-labsren.png" width="40%" style="margin-left: 34%;">
                                    </div>
                                    <br>
                                    <p style='font-size:13px; color:red;'>
                                        *pembayaran dilakukan kenomor rekening Mandiri a/n Labschool Cirendeu<br>
                                        *pembayaran diluar dari rekening yang telah di informasikan, tidak menjadi tanggung jawab pihak Labschool Cirendeu
                                    </p>
                                    <br>
                                    Saya sudah melakukan pembayaran.
                                    <form action="konfirmasi_pembayaran_psb" method="post" target="_blank">
                                        <input type="text" name="kode_daftar" value="<?=$kode_daftar;?>" style="display: none;">
                                        <button type="submit" class="block" style="margin-top:2px;">Konfirmasi Pembayaran</button>
                                    </form>
                                </div>
