        ...
        <div class="container">
            <div class="section-title row text-center" style="margin-top:50px;">
                <div class="col-md-8 offset-md-2">
                    <h3 style="margin-top:30px;">REGISTRASI PPSBB</h3>
			...
			<div class="row" style="margin-top:30px;">
				<div class="col-lg-12 col-md-12 col-12">
					<form name="regis-psb" action="controller/doRegis.php" method="post" enctype="multipart/form-data">
						<?php
                    		if(isset($_SESSION['error_reg']))
                    		{
                        		echo "<div class='alert alert-danger' style='text-align:center;'>
                            		<strong>Error!</strong>"." ".$_SESSION['error_reg'].".
                        		</div>";
