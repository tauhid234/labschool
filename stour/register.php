        ...
        <div class="container">
			...
			<div class="row" style="margin-top:30px;">
				<div class="col-lg-12 col-md-12 col-12">
					<form name="regis-stour" action="controller/doStour.php" method="post" enctype="multipart/form-data">
						<?php
						...
						<div class="form-group">
						    ...
						    <input type="text" class="form-control" id="txtKodeRegis" name="txtKodeRegis" maxlength="10" value="<?=$kode;?>" required>
						</div>
