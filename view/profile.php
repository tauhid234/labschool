			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="komplain/komplain.php">Komplain</a></li>
    ...
    <div id="overviews" class="section wb">
        <div class="container">
            <div class="row" style="margin-top: 30px;">
                ...
                <!-- <a href="https://labschoolcirendeu.sch.id/psb/" class="hover-btn-new log orange"><span>Pendaftaran</span></a> -->
                <div class="col-lg-4 overlay" style="margin-top: 60px;">
                    <p style="font-size:20px; font-weight:bold; text-align: center;">BUKU PROFIL</p>
                    <p style="font-size:14px; text-align: center; margin-top:-15px;">Labschool Cirendeu</p>
                    <img src="psb/img/profilsekolah.jpg" class="image" width="100%">
                    <a href="https://online.flippingbook.com/view/630052978/"><div class="middle">
                        <div class="text">Baca</div>
                    </div></a>
                </div>
                <!-- <div class="col-lg-2"></div> -->
                <div class="col-lg-4 overlay" style="margin-top: 60px;">
                    <p style="font-size:20px; font-weight:bold; text-align: center;">BUKU PRESTASI</p>
                    <p style="font-size:14px; text-align: center; margin-top:-15px;">SMP Labschool Cirendeu</p>
                    <img src="psb/img/pressmp.jpg" class="image" width="100%">
                    <a href="https://online.flippingbook.com/view/630083728/"><div class="middle">
                        <div class="text">Baca</div>
                    </div></a>
                </div>
                <div class="col-lg-4 overlay" style="margin-top: 60px;">
                    <p style="font-size:20px; font-weight:bold; text-align: center;">BUKU PRESTASI</p>
                    <p style="font-size:14px; text-align: center; margin-top:-15px;">SMA Labschool Cirendeu</p>
                    <img src="psb/img/pressma.jpg" class="image" width="100%">
                    <a href="https://online.flippingbook.com/view/629648110/"><div class="middle">
                        <div class="text">Baca</div>
                    </div></a>
                </div>

                <a href="http://e-sma.labschoolcirendeu.sch.id/" class="hover-btn-new"><span>E-Learning</span></a>
                <!-- <div class="col-lg-3 overlay">
                    <p style="font-size:20px; font-weight:bold; text-align: center;">PENDAFTARAN JALUR PRESTASI</p>
                    <img src="psb/img/ppssbb.jpg" class="image" width="100%">
                    <a href="https://labschool-unj.sch.id/psb"><div class="middle">
                        <div class="text">Daftar Sekarang</div>
                    </div></a>
                </div> -->
                <!-- <div class="col-lg-1"></div> -->
            </div>
            <div class="row" style="margin-top: -20px;">
                <a href="https://labschool-unj.sch.id/psb/" class="block"><span>DAFTAR SEKARANG!</span></a>
            </div>
        </div><!-- end container -->
    </div><!-- end section -->
